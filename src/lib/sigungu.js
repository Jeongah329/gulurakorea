...
/* 독도 도형 — 경계 데이터에 없어 직접 넣는다.
   울릉군(x 607~620, y 129~140) 동쪽에 두 개의 섬(동도·서도)으로 그린다.
   실제 거리(약 87km)를 축척대로 두면 지도 밖으로 나가므로 가깝게 당겨 표시한다. */
export const DOKDO_SHAPE =
  "M636.5,142.0 638.6,140.2 641.0,140.6 642.4,142.4 641.8,144.6 639.6,145.6 637.2,145.0 636.3,143.5Z " +
  "M645.5,144.8 647.3,143.4 649.3,143.9 650.3,145.6 649.5,147.4 647.4,148.0 645.6,147.0Z";
