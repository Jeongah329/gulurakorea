...
export const PERSONAL_CARDS = [
  ...
  { id:"pass",           name:"여행 패스",   icon:"🎫", desc:"진행 중인 여행 포기 · 기회 1회 환불", when:"trip" },
...
export const PERSONAL_CARD_WHEN_LABEL = {
  preroll:"주사위 굴리기 전 · 메인", envelope:"봉투 단계 · 뽑기 화면", trip:"여행 중 · 마이 탭에서 사용", mission:"미션 인증 중 · 마이 탭에서 사용", map:"내 영토 선택 · 마이 탭에서 사용", anytime:"언제든 사용",
};
