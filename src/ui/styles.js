...
export const S = {
  ...
  roomCardChip:{display:"flex",alignItems:"center",gap:6,padding:"7px 11px",borderRadius:10,border:"1.5px solid var(--line)",background:"var(--paper)",fontSize:12,fontWeight:700,color:"var(--ink)",cursor:"pointer"},
