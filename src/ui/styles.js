...
export const S = {
  ...
  modalScrim:{position:"absolute",inset:0,background:"rgba(13,23,48,.55)",display:"flex",alignItems:"center",justifyContent:"center",padding:"18px 14px",zIndex:50},
  sheet:{background:"var(--paper)",width:"100%",maxWidth:430,maxHeight:"80%",overflowY:"auto",borderRadius:20,padding:"16px 18px 20px",boxShadow:"0 14px 44px rgba(0,0,0,.4)"},
  ...
  setReason:{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"11px 13px",borderRadius:11,border:"1.5px solid var(--line)",background:"var(--paper)",cursor:"pointer",textAlign:"left"},
  ...
  setGhostBtn:{padding:"13px 20px",borderRadius:12,border:"1.5px solid var(--line)",background:"transparent",color:"var(--ink-soft)",fontSize:14,fontWeight:800,cursor:"pointer"},
  ...
  setDangerBtn:{width:"100%",padding:"13px",borderRadius:12,border:"none",background:"#FF6B6B",color:"#fff",fontSize:15,fontWeight:800,cursor:"pointer"},
  setCancelBtn:{width:"100%",padding:"11px",marginTop:4,borderRadius:12,border:"none",background:"transparent",color:"var(--ink-soft)",fontSize:13.5,fontWeight:700,cursor:"pointer"},
  gearBtn:{background:"transparent",border:"none",fontSize:19,cursor:"pointer",padding:"2px 4px",lineHeight:1},
