...
export const S = {
  ...
  logoDie:{fontSize:22,color:"var(--ink)"}, wordmark:{fontFamily:"'HiKR',sans-serif",fontSize:24,color:"var(--ink)",letterSpacing:.3},
  ...
  envFlap:{position:"absolute",top:0,left:0,right:0,height:50,borderRadius:"14px 14px 0 0",background:"var(--paper-2)",clipPath:"polygon(0 0,100% 0,50% 100%)",transformOrigin:"top center",backfaceVisibility:"hidden",zIndex:3},
  ...
  flash:{position:"absolute",top:-70,left:"50%",marginLeft:-170,width:340,height:340,background:"radial-gradient(circle closest-side, rgba(255,245,210,.95) 0%, rgba(255,238,190,.55) 32%, rgba(255,230,170,.16) 55%, transparent 100%)",zIndex:4,pointerEvents:"none"},
  ...
  overview:{fontSize:13.5,lineHeight:1.6,color:"var(--ink-soft)",whiteSpace:"pre-wrap"},
  overviewClamp:{display:"-webkit-box",WebkitLineClamp:4,WebkitBoxOrient:"vertical",overflow:"hidden"},
  moreLink:{marginTop:6,background:"transparent",border:"none",padding:"2px 0",fontSize:12.5,fontWeight:800,color:"var(--stamp)",cursor:"pointer",textDecoration:"underline",textUnderlineOffset:3},
  ...
  swapBtn:{marginTop:10,width:"100%",padding:"9px",borderRadius:10,border:"1.5px dashed var(--line)",background:"transparent",color:"var(--ink-soft)",fontSize:12.5,fontWeight:700,cursor:"pointer"},
  placeList:{marginTop:8,display:"flex",flexDirection:"column",gap:6,maxHeight:290,overflowY:"auto"},
  placeItem:{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"8px 10px",borderRadius:10,border:"1.5px solid var(--line)",background:"var(--paper)",cursor:"pointer"},
  placeItemOn:{border:"1.5px solid var(--sea)",background:"rgba(30,142,138,.08)"},
  placeThumb:{width:40,height:40,flex:"0 0 40px",borderRadius:8,background:"var(--paper-2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:17},
  ...
  cardActBtn:{flexShrink:0,background:"var(--ink)",color:"var(--paper)",border:"none",borderRadius:10,padding:"8px 12px",fontSize:11.5,fontWeight:800,cursor:"pointer"},
  ...
  extraRollBtn:{width:"100%",padding:"12px",marginBottom:8,borderRadius:14,border:"1.5px solid var(--stamp)",background:"var(--paper)",color:"var(--stamp)",fontSize:13.5,fontWeight:800,cursor:"pointer"},
  roomCardBar:{background:"var(--paper-2)",borderRadius:14,padding:"11px 13px",marginBottom:12},
  roomCardHead:{display:"flex",alignItems:"center",gap:7,width:"100%",background:"transparent",border:"none",padding:0,cursor:"pointer"},
  roomCardRow:{display:"flex",alignItems:"center",gap:9,width:"100%",padding:"9px 11px",borderRadius:12,border:"1.5px solid var(--line)",background:"var(--paper)",cursor:"pointer"},
  roomCardUse:{fontSize:11.5,fontWeight:800,color:"var(--paper)",background:"var(--stamp)",borderRadius:8,padding:"5px 10px",flexShrink:0},
  ...
  pendingTag:{fontSize:11,fontWeight:800,color:"var(--gold)",background:"rgba(227,169,44,.12)",border:"1px solid rgba(227,169,44,.4)",padding:"4px 9px",borderRadius:8,whiteSpace:"nowrap"},
  ...
  devScrim:{position:"absolute",inset:0,background:"rgba(13,23,48,.62)",display:"flex",alignItems:"center",justifyContent:"center",padding:"18px 14px",zIndex:170},
  devGroup:{background:"var(--paper-2)",borderRadius:14,overflow:"hidden",marginBottom:12},
  devRow:{display:"flex",alignItems:"center",gap:10,padding:"11px 13px",borderBottom:"1px solid rgba(22,34,63,.07)"},
  devBtn:{background:"var(--stamp)",color:"var(--paper)",border:"none",borderRadius:9,padding:"6px 11px",fontSize:11.5,fontWeight:800,cursor:"pointer",whiteSpace:"nowrap"},
  devNote:{fontSize:11.5,color:"var(--ink-soft)",lineHeight:1.6,margin:"0 0 12px",padding:"9px 12px",background:"var(--paper-2)",borderRadius:10},
  shopCoin:{display:"flex",alignItems:"center",background:"var(--paper-2)",borderRadius:14,padding:"13px 16px",marginBottom:10},
  shopGroupTitle:{fontSize:12,fontWeight:800,color:"var(--ink)",margin:"0 0 8px 2px"},
  ...
  setGroup:{background:"var(--paper-2)",borderRadius:14,overflow:"hidden"},
  setRow:{display:"flex",alignItems:"center",width:"100%",padding:"12px 14px",background:"transparent",border:"none",borderBottom:"1px solid rgba(22,34,63,.07)",textAlign:"left"},
  setReason:{display:"flex",alignItems:"center",gap:10,width:"100%",padding:"11px 13px",borderRadius:14,border:"1.5px solid var(--line)",background:"var(--paper)",cursor:"pointer",textAlign:"left"},
  setReasonOn:{border:"1.5px solid var(--stamp)",background:"rgba(19,31,60,.06)"},
  setRadio:{width:16,height:16,flex:"0 0 16px",borderRadius:"50%",border:"2px solid var(--line)",background:"transparent"},
  setRadioOn:{border:"5px solid var(--stamp)"},
  setGhostBtn:{padding:"13px 20px",borderRadius:14,border:"1.5px solid var(--line)",background:"transparent",color:"var(--ink-soft)",fontSize:14,fontWeight:800,cursor:"pointer"},
  setDangerIcon:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:52,height:52,borderRadius:"50%",background:"#FF6B6B",fontSize:24},
  setDangerBtn:{width:"100%",padding:"13px",borderRadius:14,border:"none",background:"#FF6B6B",color:"#fff",fontSize:15,fontWeight:800,cursor:"pointer"},
  setCancelBtn:{width:"100%",padding:"11px",marginTop:4,borderRadius:14,border:"none",background:"transparent",color:"var(--ink-soft)",fontSize:13.5,fontWeight:700,cursor:"pointer"},
  gearBtn:{background:"var(--stamp)",border:"none",borderRadius:"50%",width:34,height:34,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",padding:0,lineHeight:1,flexShrink:0},
  topRank:{width:22,height:22,flex:"0 0 22px",borderRadius:7,background:"var(--paper-2)",color:"var(--ink-soft)",fontFamily:"'HiKR',sans-serif",fontSize:12,display:"flex",alignItems:"center",justifyContent:"center"},
  topTrack:{height:9,borderRadius:5,background:"var(--paper-2)",overflow:"hidden"},
  boardLegend:{display:"flex",flexWrap:"wrap",gap:"6px 14px",marginBottom:14,fontSize:11.5,color:"#8A93AD"},
  boardLegendDot:{display:"inline-block",width:9,height:9,borderRadius:3,marginRight:5,verticalAlign:"-1px"},
  ...
  rankTabs:{display:"flex",gap:6,background:"var(--paper-2)",borderRadius:12,padding:4},
  rankTab:{flex:1,padding:"9px 6px",borderRadius:9,border:"none",background:"transparent",fontSize:12.5,fontWeight:800,color:"var(--ink-soft)",cursor:"pointer"},
  rankTabOn:{background:"var(--paper)",color:"var(--stamp)",boxShadow:"0 1px 4px rgba(0,0,0,.08)"},
  ...
  avatar:{width:50,height:50,borderRadius:"50%",background:"var(--ink)",display:"grid",placeItems:"center",fontSize:22,overflow:"hidden",backgroundSize:"cover",backgroundPosition:"center"},
  avatarSm:{display:"grid",placeItems:"center",width:30,height:30,borderRadius:"50%",background:"var(--ink)",fontSize:14,overflow:"hidden"},
  avatarEdit:{position:"absolute",right:-2,bottom:-2,width:20,height:20,borderRadius:"50%",background:"var(--stamp)",color:"var(--paper)",fontSize:10,display:"grid",placeItems:"center",border:"2px solid var(--paper)"},
  ...
  collRow:{display:"flex",alignItems:"center",gap:10,background:"var(--paper)",border:"1px solid var(--line)",borderRadius:10,padding:"7px 10px"},
  collDot:{width:30,height:30,flex:"0 0 30px",borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",fontSize:14},
